...
const container = document.getElementById("items-container"); // TODO 2
...
// ============================================================
function filterItems(selectedCategory) { // TODO 6a — name the parameter
switch (selectedCategory) { // TODO 6b — what are you switching on?
case "":
// Empty string means the user selected "All"
// Pass the full items array — no filtering needed
renderItems(items);
break;
case "Programming": // TODO 6c — your first category value (must match <option> value)
...
if (items[i].category === "Programming") { // TODO 6d — which category?
filtered1.push(items[i]);
}
}
renderItems(filtered1);
break;
case "Hobby": // TODO 6c — your second category value
// TODO 6d: Same pattern as above — build filtered array and render
const filtered2 = [];
for (let i = 0; i < items.length; i++) {
if (items[i].category === "Hobby") { // TODO 6d
filtered2.push(items[i]);
}
}
renderItems(filtered2);
break;
case "Experience": // TODO 6c — your third category value
// TODO 6d: Same pattern
const filtered3 = [];
for (let i = 0; i < items.length; i++) {
if (items[i].category === "Experience") { // TODO 6d
